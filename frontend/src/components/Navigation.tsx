...
import PatientScreen from '../containers/PatientScreen';
  ...
  return (
    <div className={classes.root}>
      <AppBar position="static" color="default">
        ...
        >
          <Tab label="Create contract" {...a11yProps(0)} />
          <Tab label="All contracts" {...a11yProps(1)} />
          <Tab label="Patient info" {...a11yProps(2)} />
        </Tabs>
      </AppBar>
      <SwipeableViews
